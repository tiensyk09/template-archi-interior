  ...
  return (
    <div className="admin-login-page" style={{ background: 'linear-gradient(135deg, #0a0d13 0%, #0c1017 50%, #090b10 100%)' }}>
      ...
      <div style={{
        ...
        background: `
          radial-gradient(circle at 15% 25%, rgba(176, 141, 87, 0.12) 0%, transparent 45%),
          radial-gradient(circle at 85% 75%, rgba(176, 141, 87, 0.06) 0%, transparent 45%)
        `
      }} />
      ...
      <div className="login-card" style={{
        ...
        <div className="login-logo-wrap">
          ...
          <div className="login-logo" style={{ color: '#b08d57', filter: 'drop-shadow(0 0 12px rgba(176, 141, 87, 0.8))' }}>
            🏛️
          </div>
          <div className="login-title">Admin Portal</div>
          <div className="login-sub">ARCHI – Trang quản trị</div>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div className="adm-form-group" style={{ margin: 0 }}>
            ...
            <div className="login-input-wrap">
              ...
              <input
                ...
                autoFocus
                style={{ borderColor: 'rgba(176, 141, 87, 0.3)', background: '#ffffff', color: '#0f172a', paddingLeft: '40px' }}
              />
            </div>
          </div>
          ...
          <div className="adm-form-group" style={{ margin: 0 }}>
            ...
            <div className="login-input-wrap">
              ...
              <input
                ...
                style={{ paddingRight: '44px', borderColor: 'rgba(176, 141, 87, 0.3)', background: '#ffffff', color: '#0f172a', paddingLeft: '40px' }}
              />
              <button
                type="button"
          ...
          <button
            ...
            style={{
              ...
              background: loading
                ? 'rgba(176, 141, 87, 0.4)'
                : 'linear-gradient(135deg, #b08d57 0%, #8f6f42 100%)',
              boxShadow: loading ? 'none' : '0 4px 20px rgba(176, 141, 87, 0.4)'
            }}
          >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '24px' }} className="login-back">
          ...
          <Link href="/login" style={{ color: '#d8bd8f', fontWeight: '600' }}>
      ...
      <style>{`
        .login-input:focus {
          ...
          box-shadow: 0 0 8px rgba(176, 141, 87, 0.3) !important;
        }
        .login-btn:hover:not(:disabled) {
          background: linear-gradient(135deg, #8f6f42 0%, #b08d57 100%) !important;
          box-shadow: 0 0 16px rgba(176, 141, 87, 0.5) !important;
        }
        .login-back a {
