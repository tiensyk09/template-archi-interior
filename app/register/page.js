    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <h1 style={{ fontSize: '22px', fontWeight: 900, color: '#211d18', margin: '0 0 4px 0', letterSpacing: '-0.02em' }}>
            Đăng Ký Thành Viên
          </h1>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }} autoComplete="off">
          ...
          <button
            ...
            style={{
              ...
              padding: '12px',
              marginTop: '8px',
              background: loading ? '#6b7280' : 'linear-gradient(135deg, #b08d57 0%, #8f6f42 100%)',
              border: 'none',
              borderRadius: '12px',
              color: '#ffffff',
              fontWeight: 800,
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '24px' }} className="login-back">
          ...
          <Link 
            ...
            style={{ fontSize: '13px', color: '#b08d57', fontWeight: 600, textDecoration: 'none' }}
          >
            Đã có tài khoản? →
          </Link>
        </div>
