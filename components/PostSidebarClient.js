...
export default function PostSidebarClient({ recentUpdates = [], suggestedProducts = [] }) {
  ...
  return (
    <aside style={{ display: 'flex', flexDirection: 'column', gap: '24px', position: 'sticky', top: '130px', alignSelf: 'flex-start' }}>
      ...
      {/* 1. Contact CTA - ARCHI */}
      <div style={{
        background: 'linear-gradient(135deg, #b08d57 0%, #0a4f26 100%)',
        color: '#ffffff',
        borderRadius: '16px',
        padding: '24px',
        ...
        <p style={{ fontSize: '13px', lineHeight: 1.5, opacity: 0.9, margin: '0 0 16px 0' }}>
          Liên hệ trực tiếp để được kiến trúc sư tư vấn giải pháp thiết kế & thi công tận tình, chu đáo.
        </p>
      ...
      {suggestedProducts.length > 0 && (
        <div style={{
          ...
          <h3 style={{ fontSize: '15px', fontWeight: 800, color: '#211d18', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '2px solid #f0faf4', paddingBottom: '8px' }}>
                ...
                <div key={prod.id} style={{ display: 'flex', flexDirection: 'column', gap: '8px', paddingBottom: '12px', borderBottom: '1px solid #f3f4f6' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minWidth: 0 }}>
                      ...
                      <div>
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px', flexWrap: 'wrap' }}>
                          <span style={{ fontSize: '13.5px', fontWeight: 700, color: '#b08d57' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: addingId === prod.id ? '#fff' : '#b08d57',
                      fontWeight: 700,
                      fontSize: '11.5px',
                      cursor: 'pointer',
                      display: 'flex',
                    ...
                    onMouseLeave={(e) => {
                      if (addingId !== prod.id) {
                        e.currentTarget.style.background = '#f4efe7';
